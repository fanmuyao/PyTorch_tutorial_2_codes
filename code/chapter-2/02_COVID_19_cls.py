...
def main():
    ...
    root_dir = r"C:\Users\ot1h8w\OneDrive - Aptiv\Documents\muyaoWorkSpace\codes from git\PyTorch_tutorial_2_codes\data\covid-19-demo"  # path to datasets——covid-19-demo
